    ...
    return (
        <div className='header'>
            ...
            <div className='header-info'>
                ...
                <a href="https://drive.google.com/file/d/1JwAggShyrfCqhPJ6OEeK0lo3lbO5Adv5/view?usp=sharing" target='_blank' rel="noreferrer"><button className='curriculum'>Descargar CV</button></a>
            </div>
        </div>
    )
}
